...
pub fn HomePage() -> Element {
    ...
    rsx! {
        main {
            class: "flex-1 w-full overflow-y-auto lg:overflow-hidden p-2 sm:p-4 md:p-8 flex flex-col",

            // Desktop layout (side by side)
            div {
                class: "hidden lg:flex lg:flex-row gap-2 sm:gap-4 md:gap-8 lg:h-full",
                div {
            ...
            div {
                class: "flex flex-col lg:hidden flex-1",
                // Content area
                div {
